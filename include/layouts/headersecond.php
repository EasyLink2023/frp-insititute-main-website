            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="eventsDropdown">
                        <a class="dropdown-item" href="<?php echo BASE_URL; ?>event1.php">Upcoming Events</a>
                        
                        <!-- Past Events dropdown with hover effect -->
                        <div class="dropdown-submenu">
                            <a class="dropdown-item dropdown-toggle" href="#">Past Events</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>past-event1.php">Past Webinar PPT</a></li>
                            </ul>
                        </div>
                    </div>
                </li>

...
.nav-item.dropdown .dropdown-menu {
  margin-top: 0; /* Ensure no margin when not hovered */
}
...
.main-heading {
  ...
  /* Animation */
  animation: slide-in-right 1s ease-out forwards; /* Adjust duration and easing */
}
...
.main-heading-text {
  ...
  /* Animation */
  animation: slide-in-right 1s ease-out forwards; /* Adjust duration and easing */
  animation-delay: 0.2s; /* Optional: Add delay for staggered effect */
}
...
.custom-card:hover .card-icon , .custom-card:hover .card-body h3 , .custom-card:hover .card-body p{
    color: #fff !important;
}
...
.media-body .heading, .media-body p{
    color: #fff !important;
}
.frp-institute-section{
...
.sticky-section {
  ...
  top: 20px !important; /* Adjust this value to the distance from the top */
}
            ...
            <div class="col-md-6 pl-md-5">
                ...
                <div class="form-volunteer">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            <!-- <label for="email">Email</label> -->
                            <input type="text" class="form-control py-2" id="email" placeholder="Enter your phone">
                        </div>
                        <div class="form-group">
